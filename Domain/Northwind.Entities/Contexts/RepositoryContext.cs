...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-0GRTEHQ\\SQLEXPRESS;Initial Catalog=Northwind;Trusted_Connection=True");
            }
        }*/
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductAudit>(entity =>
            {
                ...
                entity.Property(e => e.ChangesAt)
                    .HasColumnType("datetime")
                    .HasColumnName("changes_at");

                entity.Property(e => e.ProductId).HasColumnName("product_id_");
            ...
            modelBuilder.Entity<SemuaProduct>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("SemuaProduct");
